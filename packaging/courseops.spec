...
exe = EXE(
    ...
    # the build failed there, which is the machine that matters. favicon.ico is
    # generated by tools/make_icons.py alongside the PNGs.
    icon=str(PACKAGE / "static" / "favicon.ico"),
)
